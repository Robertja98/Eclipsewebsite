...
<section class="container two-col">
  <div>
    <h2>Our promise</h2>
    <ul class="checklist">
      <li><strong>Service:</strong> Hands-off maintenance and tank exchanges</li>
      <li><strong>Speed:</strong> Local branches for quick installation</li>
      <li><strong>Quality:</strong> Tested to meet demanding specifications</li>
      <li><strong>Support:</strong> Broad technical experience and guidance</li>
    </ul>
  </div>
  <div class="highlight">
    <h2>Canadian advantage</h2>
    <p>Headquartered in Canada, we’re not affected by U.S. tariffs. That means stable pricing, dependable supply, and less risk for your operations.</p>
  </div>
</section>
