...
<head>
    ...
    <title>Resin Tank Sizing Calculator | Eclipse Water Technologies</title>
    ...
    <style>
        .calc-form {
            ...
            background: #fff;
            border-radius: 18px;
            box-shadow: 0 4px 32px rgba(0,51,102,0.07), 0 1.5px 8px 0 rgba(0,153,168,0.04);
            ...
            .calc-form select {
                ...
                -moz-appearance: none;
                background-image: url('data:image/svg+xml;utf8,<svg fill="%230099A8" height="20" viewBox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path d="M7 10l5 5 5-5z"/></svg>');
        ...
        @media (max-width: 1200px) {
            .calc-form { width: 98vw; max-width: none; padding: 1.2rem; }
        }
        .calc-form label { display: block; margin-top: 1rem; font-weight: 600; }
        .calc-form input { width: 100%; padding: 0.5rem; margin-top: 0.25rem; border-radius: 6px; border: 1px solid #ccc; }
        .calc-form button { margin-top: 1.5rem; }
            .calc-results { margin-top: 2rem; background: #f3fbfc; border: 1px solid #d9eff2; border-radius: 8px; padding: 1rem; }
            .calc-results strong { color: var(--blue); }
        }
        .calc-form {
            width: 98vw;
            max-width: 1600px;
        ...
        @media (max-width: 1200px) {
            .calc-form { max-width: 98vw; padding: 1.2rem; }
        }
        .calc-results { margin-top: 2rem; background: #f3fbfc; border: 1px solid #d9eff2; border-radius: 8px; padding: 1rem; }
        .calc-results strong { color: var(--blue); }
    </style>
...
<body>
    <?php include 'navbar.php'; ?>
        <section class="hero hero-sub">
            <div class="container">
                <h1>Resin Tank Sizing Calculator</h1>
                <p style="font-size:1.18em;max-width:700px;margin:0.7em auto 0;">Not sure what size DI tank you need? This step-by-step tool will help you choose the right tank for your water usage—even if you know nothing about water treatment. Just follow the prompts below!</p>
            </div>
        </section>
